...
export const SET_COMMUNITIES_CACHE = 'SET_COMMUNITIES_CACHE';
export const UPDATE_COMMUNITIES_CACHE = 'UPDATE_COMMUNITIES_CACHE';
export const DELETE_COMMUNITIES_CACHE = 'DELETE_COMMUNITIES_CACHE';
export const DEFAULT_USER_DRAFT_ID = 'DEFAULT_USER_DRAFT_ID_';
export const SET_FETCHING_SUBSCRIBED_COMMUNITIES = 'SET_FETCHING_COMMUNITIES';
export const SET_SUBSCRIBING_COMMUNITY = 'SET_SUBSCRIBING_COMMUNITY';
export const SET_DISCOVER_COMMUNITIES_CACHE = 'SET_DISCOVER_COMMUNITIES_CACHE';
export const UPDATE_DISCOVER_COMMUNITIES_CACHE = 'UPDATE_DISCOVER_COMMUNITIES_CACHE';
export const SET_FETCHING_DISCOVER_COMMUNITIES = 'SET_FETCHING_DISCOVER_COMMUNITIES';
