...
export const SET_FCM_AVAILABLE = 'SET_FCM_AVAILABLE';
...
export const CHANGE_TAGS_NOTIFICATION = 'CHANGE_TAGS_NOTIFICATION';
...
export const UPDATE_APP_RATING_META = 'UPDATE_APP_RATING_META';
...
export const SET_IMAGE_SERVER = 'SET_IMAGE_SERVER';
...
export const UPDATE_UNREAD_CHAT_COUNT = 'UPDATE_UNREAD_CHAT_COUNT';
...
export const SET_WAVE_TAGS = 'SET_WAVE_TAGS';
export const SET_WAVE_CONTAINERS = 'SET_WAVE_CONTAINERS';

// EDITOR
export const SET_BENEFICIARIES = 'SET_BENEFICIARIES';
export const SET_POLL_DRAFT = 'SET_POLL_DRAFT';
export const SET_DRAFT_CARET = 'SET_DRAFT_CARET';
export const REMOVE_EDITOR_CACHE = 'REMOVE_EDITOR_CACHE';
export const SET_ALLOW_SPK_PUBLISHING = 'SET_ALLOW_SPK_PUBLISHING';
export const REMOVE_POLL_DRAFT = 'REMOVE_POLL_DRAFT';
export const SET_DEFAULT_REWARD_TYPE = 'SET_DEFAULT_REWARD_TYPE';
...
export const UPDATE_REPLY_CACHE = 'UPDATE_REPLY_CACHE';
export const DELETE_REPLY_CACHE_ENTRY = 'DELETE_REPLY_CACHE_ENTRY';
...
export const UPDATE_SPOTLIGHT_META = 'UPDATE_SPOTLIGHT_META';
export const UPDATE_PROPOSALS_VOTE_META = 'UPDATE_PROPOSALS_META';

// WALKTHROUGH
export const REGISTER_WALKTHROUGH_ITEM = 'REGISTER_WALKTHROUGH_ITEM';
