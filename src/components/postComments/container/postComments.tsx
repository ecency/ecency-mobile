    ...
    const _renderItem = ({ item, index }) => {
      return (
        <CommentsSection
          ...
          handleOnEditPress={_handleOnEditPress}s
          ...
          onUpvotePress={(content, anchorRect, showPayoutDetails) => onUpvotePress({ anchorRect, showPayoutDetails, content, postType: PostTypes.COMMENT })}
        />
      )
    }
