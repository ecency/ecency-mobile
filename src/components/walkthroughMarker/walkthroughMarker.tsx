...
export const WalkthroughMarker = ({ 
    ...
    markerStyle, 
    walkthroughIndex, 
    onInterceptComplete }:WalkthroughMarkerProps) => {

    const dispatch = useDispatch();
    const tooltipRegistered = useSelector(
        (state) => state.walkthrough.walkthroughMap.get(walkthroughIndex));
    ...
    return (
        <View style={styles.container}>
            ...
            {!hidden && !tooltipRegistered &&
                <View style={{ ...styles.redDot, ...markerStyle }} />
            }
        </View>
    );
};
